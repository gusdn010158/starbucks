  ...
  <section className="Body_second" >
    <div className="Body_second_divpia">
        <div className="Body_second_a">
                <img  className="divpia_logo"src="https://image.istarbucks.co.kr/upload/common/img/main/2023/2023_newyear_top_logo.png" alt="HAPPY 2023 FIND YOUR LUCK" />
       </div>
       <div className="divpia_button">
                <a className="divpia_a" href="https://www.starbucks.co.kr/whats_new/campaign_view.do?pro_seq=2111">자세히 보기</a>
        </div>
<div className="divpia_img">
<div className="divpia_img1">
<img className="tea_img1" src="https://image.istarbucks.co.kr/upload/common/img/main/2023/2023_newyear_top_drink_1_1.png" alt="골든 미모사 그린 티" />
</div>
<div className="divpia_img2">
<img className="tea_img2" src="https://image.istarbucks.co.kr/upload/common/img/main/2023/2023_newyear_top_drink_2_1.png" alt="블랙 햅쌀 고봉 라떼" />
</div>
<div className="divpia_img3">
<img className="tea_img3" src="https://image.istarbucks.co.kr/upload/common/img/main/2023/2023_newyear_top_drink_3_1.png" alt="스타벅스 튜메릭 라떼" />
</div>
</div>
           ...
           <img src="https://image.istarbucks.co.kr/common/img/main/rewards-logo.png" alt="Starbucks Rewards"/>
            ...
            <div className="Body_third_top">
              ...
              <p className="Body_third_top_txt_p">스타벅스 회원이세요? 로그인을 통해 나만의 리워드를 확인해보세요.<br></br>스타벅스 회원이 아니세요? 가입을 통해 리워드 혜택을 즐기세요.</p>
              <hr></hr>
              </div>
              <div className="Body_third_top_button">
              <a className="Body_third_top_button_a1" href="/mem/join.do">회원가입</a>
              <a className="Body_third_top_button_a2" href="javascript:$.loginLib.showLayerLogin();">로그인</a>
              </div>
            </div>
            <div className="Body_third_bottom">
              <p>회원 가입 후, 스타벅스 e-Gift Card를 "나에게 선물하기"로 구매하시고, 편리하게 등록하세요!<br></br>카드를 등록하여 스타벅스 리워드 회원이 되신 후, 첫 구매를 하시면 무료 음료쿠폰을 드립니다!</p>
              <a className="Body_third_buttom_a" href="/msr/sceGift/gift_step1.do">e-Gift Card 선물하기</a>
            </div>
            </div>
            </section>
            ...
            <section className="Body_first">
                <div className="Body_first_div">
                    <div className="Body_first_diva" >
                        <img className="Body_first_diva_img" src="https://image.istarbucks.co.kr/upload/common/img/main/2023/2023_newyear_promotion_img.png" alt="엘살바도르 아우아차판" />
                        
                    </div>
                    <div className="Body_first_divb" > 
                        <img className="Body_first_divb_img" src="https://image.istarbucks.co.kr/upload/common/img/main/2023/2023_newyear_promotion_txt.png" alt="크리스마스를 더욱 특별하게 만들어 줄 원두 크리스마스 블렌드" />
                    </div>
                    <div className="Body_first_Button">
                        <a href="https://www.starbucks.co.kr/coffee/product_view.do?PRODUCT_CD=11135964">자세히 보기</a>
                    </div>
                </div>
            </section >
            ...
            <img  className="Body_f_div_txt_img" src="https://image.istarbucks.co.kr/upload/common/img/main/2022/221220_pc_reserve_logo.png" alt="INDONESIA WEST JAVA"/>
            </div>
            <div className="Body_f_div_logo">
            <img className="Body_f_div_logo_img" src="https://image.istarbucks.co.kr/img/event/2022/2212201_pc_reserve_coffee_bg.png" alt=""/>
            </div> 
            <div className="Body_f_div_button">
            <a href="https://www.starbucks.co.kr/whats_new/newsView.do?seq=4790">자세히 보기</a>
              </div> 
            </div>
            </section>
...
<div className="Body_six_div">
  <div className="Body_six_div_img">
        <img src="https://image.istarbucks.co.kr/upload/common/img/etc/reserve_text_pc.png" alt="리저브 매거진에서 일상 속 특별함을 만나보세요."/>
  </div>
